...
I am an aspiring software engineer and Python developer with an interest in Artificial Intelligence, Machine Learning 
and full-stack web development. I enjoy building practical, secure and user-focused applications.
...
![SDLC](https://img.shields.io/badge/SDLC-007ACC?style=for-the-badge&logo=git&logoColor=white)
...
- Implemented AES-256 encryption, SHA-256 deduplication, ECC cryptography, and ransomware detection.
- Designed automated backup and recovery workflows for a scalable and maintainable solution.
...
- Developed machine-learning models for lung disease detection using CNN, XGBoost, and SVM.
...
- Implemented uptime monitoring, response-time tracking, and error logging.
